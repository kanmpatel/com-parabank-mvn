...
public class PropertyReader {
    ...
    */
    ...
    public String getProperty(String propertyName){
        ...
        try {
            inputStream = new FileInputStream(System.getProperty("user.dir")+"/src/test/java/htm/index/parabank/com/parasoft/parabank/resources/propertiesfile/config.properties");
